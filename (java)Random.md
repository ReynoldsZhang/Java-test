...
public class random {
    public static void main(String[] args) {
        ...
        Collections.addAll(arrayList, "TonyZ",   "Justin", "Edwin",  "TonyS");//这可以改
        System.out.print("输入分类个数： ");
    ...
    private static ArrayList<ArrayList<String>> split(ArrayList<String> original, int num) throws Exception{
        if (original.size() < num){
            throw new SplitException("Can't split: Too many groups. 你应该输入少于 " + (original.size() + 1) + " 个组.");
        }
